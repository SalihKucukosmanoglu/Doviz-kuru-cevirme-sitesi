...
let API_KEY = "fca_live_CGA6CxnwmstM2fQUmDoM2y8QMcpf57qzjicWKKNm";
...
export default function () {
    ...
    const [toCurrency, setToCurnncey] = useState('TRY');
    ...
    return (
        <div className='currency-div'>
            ...
            <div style={{ marginTop: '25px' }}>
                ...
                <select onChange={(e) => setToCurnncey(e.target.value)} className='to-currency-option'>
                    <option>USD</option>
                    <option>EUR</option>
                    <option>TRY</option>
                </select>
            ...
            <div><button
                onClick={exchange}
                className='exchange-buton'>Çevir</button></div>
        </div>
